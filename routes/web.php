...
Route::get('/header', function () {
    ...
    return view('index', compact("headerLinks"));
})->name('header');
...
Route::get('/Comics', function () {
    ...
    $comics = [
        ["immagine" => "/resources/img/buy-comics-digital-comics.png", "titolo" => "digital comics"],
        ["immagine" => "/resources/img/buy-comics-merchandise.png", "titolo" => "merchandise"],
        ["immagine" => "/resources/img/buy-comics-subscriptions.png", "titolo" => "subscription"],
        ["immagine" => "/resources/img/buy-comics-shop-locator.png", "titolo" => "comics shop locator"],
        ["immagine" => "/resources/img/buy-dc-power-visa.svg", "titolo" => "dc power visa"],
    ];
    ...
    $socials = [
        ["id" => "1", "social" => 'facebook', "url" => "/resources/img/footer-facebook.png"],

        ["id" => "2", "social" => 'twitter', "url" => '/resources/img/footer-twitter.png'],

        ["id" => "3", "social" => 'youtube', "url" => '/resources/img/footer-youtube.png'],

        ["id" => "4", "social" => 'pinterest', "url" => '/resources/img/footer-pinterest.png'],

        ["id" => "5", "social" => 'periscope', "url" => '/resources/img/footer-periscope.png']
    ];

    return view('index',  compact("headerLinks", "comics", "singleComics", "dcComicsLinks", "shops", "dcs", "sites", "socials"));
})->name('Comics');
...
Route::get('/products', function () {
    ...
    return view('index', compact("singleComics"));
})->name('products');
